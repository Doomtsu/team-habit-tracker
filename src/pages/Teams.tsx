    ...
    <Layout>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="glass-card p-6 rounded-lg hover-lift animate-fade-in dark:bg-gray-800 dark:text-white">
            <Users className="h-8 w-8 text-primary mb-2 animate-float" />
            <h3 className="text-xl font-semibold mb-1">Total Teams</h3>
            <p className="text-3xl font-bold">{teams.length}</p>
          </div>
          <div className="glass-card p-6 rounded-lg hover-lift animate-fade-in dark:bg-gray-800 dark:text-white" style={{ animationDelay: "0.1s" }}>
          ...
          <div className="glass-card p-6 rounded-lg hover-lift animate-fade-in dark:bg-gray-800 dark:text-white" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="glass-card rounded-lg overflow-hidden animate-fade-in dark:bg-gray-800" style={{ animationDelay: "0.3s" }}>
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/50 dark:bg-gray-700 dark:text-gray-200">
            ...
            <TableBody>
              {teams.map((team) => (
                <TableRow 
                  key={team.id}
                  className="hover:bg-muted/50 dark:hover:bg-gray-700 dark:text-gray-200 transition-colors duration-200"
                >
